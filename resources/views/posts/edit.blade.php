...
<html lang="en">
  ...
  <body>
		...
		<div class="container">
          ...
          {{ Form::select('tags[]', $tags, null, ["class" => "form-control multiple-tags-select2",'multiple'=>'multiple']) }}
					{{Form::label('body','Post Body:')}}
					{{Form::textarea('body',null,array('class'=>'form-control'))}}
          {!!Html::linkRoute('posts.show', 'Cancel', array($post->id), array('class' => 'btn btn-danger btn-md btn-block'))!!}
					{{Form::submit('Save Changes',array('class'=>'btn btn-info btn-lg btn-block','style'=>'margin-top:20px;'))}}
					{!! Form::close() !!}
